(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(mod.exports);
    global.jqueryZsTooltipM = mod.exports;
  }
  ...
  (function ($) {
    ...
    var _defaults = {
      alignment: 'center',
      // Alignment of the tooltip respective to the parent element
      animation: null,
      arrowAlignment: 'center',
      // Alignment of the arrow respective to the tooltip bubble
      events: {},
      position: 'top',
      // Position of the tooltip around the parent element
      text: '',
      triggers: 'hover',
    ...
    zsTooltip.prototype.setAnimation = function ($tooltip) {// TODO: develop this in next release after 2.1		
    };
    ...
    zsTooltip.prototype.setPosition = function (tooltip) {// TODO: develop this in next release after 2.1
    };
    ...
    $.fn.zsTooltip = function (opt) {
      ...
      var options = $.isPlainObject(opt) || !opt ? $.extend(true, {}, _defaults, opt) : $.extend(true, {}, _defaults);
  ...
  var _default = jQuery.fn.zsTooltip;
  _exports.default = _default;
});
//# sourceMappingURL=jquery.zsTooltip.js.map
